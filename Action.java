...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean switchToDefaultFrame(WebDriver driver) {
		...
		try {
			...
			if (flag) {
				System.out.println("the frame moved to main frame");
			} else if (!flag) {
				System.out.println("the frame moved to main frame");
			}
		}
	...
	public boolean switchToOldWindow(WebDriver driver) {
		...
		try {
			...
			Set<String> s = driver.getWindowHandles(); // Get all open window handles
	        Object popup[] = s.toArray(); // Convert to array
	        driver.switchTo().window(popup[0].toString()); // Switch to the first window (old window)
	        flag = true;
	        return true;
		} catch (Exception e) {
			flag = false;
	...
	public int getColumncount(WebElement row) {
		List<WebElement> columns = row.findElements(By.tagName(".//td | .//th\""));
		int a = columns.size();
	...
	@Override
	public boolean switchToparenttFrame(WebDriver driver) {
		boolean flag = false;
		try {
			...
			if(flag) {
				System.out.println("the frame was moved to parent");
			}
			else {
				System.out.println("the frame was not moved to parent");
			}
		}
		return flag;
	}
	...
	@Override
	public boolean closeallWindow(WebDriver driver) {
